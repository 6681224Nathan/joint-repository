...
public class NewMainEx3 {
    ...
    /* 
        ...
        Invalid input type, 0 instead of o, 1 instead of i                  ,NOT COMPLETE
        wrong splitter, l instead of comma                                  ,NOT COMPLETE
        wrong 3-letters airport code NO EXCEPTION                           ,NOT COMPLETE
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        fileScan = createFileScanner(path, "airlines.txt"); //use file scanner creator from Project 1, has Exception proof
