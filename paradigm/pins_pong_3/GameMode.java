...
class GameMode extends JPanel implements MouseMotionListener, KeyListener
{
    ...
    public boolean getCryBabyChance() { return cryBabyChance;}
    public int getSwingState(){ return swingState;}
    public int getPercentChance(){ return percentChance;}
    ...
    public void setIntUserLoc(int intUserLoc) {this.intUserLoc = intUserLoc; }
     ...
     public void setCryBabyChance(boolean cryBabyChance) {this.cryBabyChance = cryBabyChance; }
     public void setSwingState(int swingState) { this.swingState = swingState; }
     public void setPercentChance(int percentChance) { this.percentChance = percentChance; }
   ...
   public void cryBaby()
   {
          ...
          setBetterAi(false);
          setAcMissMode(true);
          //setOscillation(true); //if better AI is turned off, oscillation will not work anyway, so this line has no effect
